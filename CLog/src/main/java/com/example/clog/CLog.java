...
public class CLog implements Log.LogImp {

    // Used to load the 'clog' library on application startup.
    static {
        System.loadLibrary("CLog");
    }

    /**
     * A native method that is implemented by the 'clog' native library,
